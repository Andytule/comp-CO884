...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="scoreGridView" runat="server" AutoGenerateColumns="False" CssClass="table-condensed" DataKeyNames="game_id" DataSourceID="scoreSqlDataSource" EmptyDataText="There are no data records to display." BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
        <Columns>
