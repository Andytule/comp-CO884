        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Departments>(entity =>
            {
                entity.HasKey(e => e.DepartmentId)
                    .HasName("PK__departme__C22324225E6921EB");
            ...
            modelBuilder.Entity<Items>(entity =>
            {
                entity.HasKey(e => e.ItemId)
                    .HasName("PK__items__52020FDD0B6359B4");
            ...
            modelBuilder.Entity<Medications>(entity =>
            {
                entity.HasKey(e => e.MedicationId)
                    .HasName("PK__medicati__DD94789BF25856F3");
            ...
            modelBuilder.Entity<NursingUnits>(entity =>
            {
                entity.HasKey(e => e.NursingUnitId)
                    .HasName("PK__nursing___0E85E2CC2A998D51");
            ...
            modelBuilder.Entity<Patients>(entity =>
            {
                entity.HasKey(e => e.PatientId)
                    .HasName("PK__patients__4D5CE4761C6DBB1D");
            ...
            modelBuilder.Entity<Physicians>(entity =>
            {
                entity.HasKey(e => e.PhysicianId)
                    .HasName("PK__physicia__8C035A3C329B690B");
            ...
            modelBuilder.Entity<Provinces>(entity =>
            {
                entity.HasKey(e => e.ProvinceId)
                    .HasName("PK__province__08DCB60F6075E694");
            ...
            modelBuilder.Entity<PurchaseOrders>(entity =>
            {
                entity.HasKey(e => e.PurchaseOrderId)
                    .HasName("PK__purchase__AFCA88E6A37240B1");
            ...
            modelBuilder.Entity<UnitDoseOrders>(entity =>
            {
                entity.HasKey(e => e.UnitDoseOrderId)
                    .HasName("PK__unit_dos__BB64A31A7844F3A4");
            ...
            modelBuilder.Entity<Vendors>(entity =>
            {
                entity.HasKey(e => e.VendorId)
                    .HasName("PK__vendors__0F7D2B781E9FFB45");
